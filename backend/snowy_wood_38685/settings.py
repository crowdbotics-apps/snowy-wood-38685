"""
Django settings for snowy_wood_38685 project.
...
ROOT_URLCONF = 'snowy_wood_38685.urls'
...
WSGI_APPLICATION = 'snowy_wood_38685.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snowy_wood_38685 API",
    "DESCRIPTION": "API documentation for snowy_wood_38685 App",
    "VERSION": "v1",
}
